...
#
# create_project.tcl: Tcl script for re-creating project 'fir'
#
# Generated by Vivado on Fri Nov 26 13:27:06 +0800 2021
...
#    "C:/Users/falwa/workspace/code_repo/fir/sim_fir.v"
#
#*****************************************************************************************
...
set files [list \
 [file normalize "${origin_dir}/multadd.v"] \
 [file normalize "${origin_dir}/../common/pipe_delay.v"] \
 [file normalize "${origin_dir}/fir.v"] \
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "fir" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/sim_fir.v"] \
]
add_files -norecurse -fileset $obj $files
...
set obj [get_filesets sim_1]
set_property -name "top" -value "sim_fir" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7vx690tffg1761-2 -flow {Vivado Synthesis 2018} -strategy "Synthesis_OOC" -report_strategy {No Reports} -constrset constrs_1
} else {
  set_property strategy "Synthesis_OOC" [get_runs synth_1]
...
set obj [get_runs synth_1]
set_property -name "strategy" -value "Synthesis_OOC" -objects $obj
